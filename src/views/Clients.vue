<template>
  <div class="c-conteiner settings" fluid>
    <md-toolbar class="md-toolbar-settings" md-elevation="1">
      <h3 class="md-title" style="flex: 1">Clientes</h3>
      <md-button class="md-primary">Nuevo</md-button>
    </md-toolbar>
    <div class="c-tablet" >
      <md-table>
        <md-table-row>
        ...
        <md-table-row v-for="user in paginate(users)" :key="user.id">
      ...
      <ul class="paginate">
          <li >
            <md-button class="md-icon-button  md-raised" @click="setPage(1)">
            <md-icon>keyboard_arrow_left</md-icon>
            </md-button>
          </li>
          <li v-for="pageNumber in totalPages" :key="pageNumber">
            <md-button class="md-icon-button  md-raised" @click="setPage(pageNumber)">
              {{ pageNumber }}
            </md-button>
          </li>
          <li >
            <md-button class="md-icon-button  md-raised" @click="setPage(totalPages)">
